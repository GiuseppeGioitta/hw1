...
<head>
    ...
    <title>Goditi le ricette | Kellogg's</title>
    <link rel="stylesheet" href="pagina_ricette.css">
    <link href="https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300..800;1,300..800&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <script src="pagina_ricette.js" defer></script>
</head>
<header>
        <div class="first">
            <div class="logo">
    ...
    <div class = "piccola_barra">
        ...
        <span class = "testo">Ricette Generali</span>
    </div>

        <h4>Cerca la tua ricetta di interesse specificandone la tipologia</br></h4>
