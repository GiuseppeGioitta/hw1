...
<head>
    ...
    <title>Valori Nutrizionali | Kellogg's</title>
    <link rel="stylesheet" href="pagina_calorie.css">
    <link href="https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300..800;1,300..800&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <script src="pagina_calorie.js" defer></script>
</head>
<header>
        <div class="first">
            <div class="logo">
        ...
        <div class="second">
            ...
            <a class="kcal hidden" href="edamam.html"><img src="calorie.png" alt=""></a>
    ...
    <div class = "piccola_barra">
        ...
        <span class = "testo">Valori Nutrizionali</span>
    </div>

        <h4>Inserisci la quantità e l'alimento di tuo interesse per scoprire i valori nutrizionali</br></h4>
        <form name="search_content" id="calorie">
            <label>Inserisci quantità ed alimento:</label>
            <input type='text' name='search' id='content'>	
            <input type='submit' value='CERCA'>
            </form>
        <div id='Valori'></div>
            <div id='errore' class='hidden'> 
            <img src="wrong.png"/></br>
            Non sono stati trovati alimenti inerenti </br> Prova con un altra tipologia</div>
            <footer>
